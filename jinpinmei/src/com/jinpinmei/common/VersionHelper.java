...
public class VersionHelper {
	...
	public static final String UPDATE_APKNAME = "jinpinmei.apk";
	public static final String UPDATE_VERJSON = "jinpinmeiapk.html";
	public static final String UPDATE_SAVENAME = "jinpinmei.apk";
