...
import com.jinpinmei.adapter.CatalogAdapter;
import com.jinpinmei.common.AlertHelper;
import com.jinpinmei.common.UpdateHelper;
import com.jinpinmei.manager.MenuManager;
import com.jinpinmei.util.Constant;
import com.jinpinmei.util.TextReader;
import com.jinpinmei.util.Utils;
import com.jinpinmei.view.BookView;
import com.jinpinmei.view.BookViewFlipper;
import com.jinpinmei.view.HelpWinReader;
import com.jinpinmei.view.KanShuDialog;
import com.jinpinmei.view.Loading;
...
public class JinpinmeiActivity extends Activity implements OnItemClickListener,
		GestureDetector.OnGestureListener
{
	private static final String TAG = "JinpinmeiActivity";
	/** 其他书籍 */
	private static String OtherBook="";
	...
	private void AddGoogleAd(){
		adView = new AdView(JinpinmeiActivity.this, AdSize.BANNER,
				"a14f292df2c0535");
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		OtherBook = this.getResources().getString(R.string.otherbook);
		...
		// ===============此处为自动检查更新部分==================
				checkUpdateHandler.post(new Runnable()
				{
					...
					public void run()
					{
						...
						if (UpdateHelper.CheckNewVersion(JinpinmeiActivity.this))
						{
							UpdateHelper.ExcuteUpdateVersion(JinpinmeiActivity.this);
						}
					}
				});
	...
	private void bookView(Boolean isShow)
	{
		...
		menu = new MenuManager(JinpinmeiActivity.this, mBookView);
...
//	}
	...
	public boolean onPrepareOptionsMenu(Menu menu)
	{
		...
		else if(mCurrView == Views.MAIN_VIEW)
		{
			menu.add(0, 1, 1, "资源列表").setIcon(R.drawable.download);
		}
		else
			menu.clear();
		...
		if(mCurrView == Views.BOOK_VIEW){
			...
			switch (item.getItemId())
			{
				case 1://调整字体大小
					//menu.ShowFont(GetSize());
					//bookView();
					AlertHelper.AlertDialog_List(this, "其他资源", OtherBook.split(","), downClickListener);
					break;
				default:
					break;
			}
	...
	DialogInterface.OnClickListener downClickListener = new OnClickListener()
	{
		@Override
...
//						UpdateHelper.ExcuteUpdateVersion(JinpinmeiActivity.this);
//					}
					String apkName = OtherBook.split(",")[index];
					UpdateHelper.GetResources(JinpinmeiActivity.this, apkName+".apk");
				}
			});
		}
	};
	...
	{
		AlertHelper.AlertDialog_YesorNo(this, getString(R.string.exit_dialog_title),
